package net.bluefish.tutorialmod.screen;

import com.mojang.blaze3d.systems.RenderSystem;
import net.bluefish.tutorialmod.util.FluidStack;
import net.bluefish.tutorialmod.util.MouseUtil;
import net.fabricmc.fabric.api.transfer.v1.fluid.FluidConstants;
import net.bluefish.tutorialmod.TutorialMod;
import net.bluefish.tutorialmod.screen.renderer.EnergyInfoArea;
import net.bluefish.tutorialmod.screen.renderer.FluidStackRenderer;
