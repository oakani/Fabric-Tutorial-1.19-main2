package net.bluefish.tutorialmod.block.entity;
...
import net.bluefish.tutorialmod.recipe.GemInfusingRecipe;
import net.bluefish.tutorialmod.screen.GemInfusingScreenHandler;
import net.bluefish.tutorialmod.util.FluidStack;
